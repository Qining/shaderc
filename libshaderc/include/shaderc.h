...
// Set the copmiler to only do preprocessing. When both preprocessing only mode
// and disassembly mode are turned on, the compiler will respects preprocessing only
// mode.
void shaderc_compile_options_set_preprocessing_only_mode(shaderc_compile_options_t options);
